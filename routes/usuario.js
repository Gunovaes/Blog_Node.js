                                    ...
                                    bcrypt.hash(novoUsuario.senha, salt, (err, hash) => {
                                        ...
                                        new Usuario(novoUsuario)
                                            ...
                                            .then(() => {
                                                ...
                                                res.render("retornar", { success_msg: req.flash("success_msg") });
                                            })
                                            .catch((err) => {
...
router.post("/login", (req, res, next) => {
    passport.authenticate("local", (err, user) => {
        ...
        if (!user) {
            ...
            return res.render("usuario/login", { error_msg: req.flash("error_msg") });
        }
        req.logIn(user, (err) => {
            if (err) {
                return next(err);
            ...
            return res.render("retornar", { success_msg: req.flash("success_msg") });
        });
    })(req, res, next);
});
